...
# #print(get_clock_hands(read_clock))
task2_hr = get_clock_hands(plt.imread('clock_images/batch_0/clock_34.png'))[0]
task2_min = get_clock_hands(plt.imread('clock_images/batch_0/clock_34.png'))[1]
task_hr = get_clock_hands(plt.imread('clock_images/batch_0/clock_27.png'))[0]
task_min = get_clock_hands(plt.imread('clock_images/batch_0/clock_27.png'))[1]
task3_hr = get_clock_hands(plt.imread('clock_images/batch_2/clock_19.png'))[0]
task3_min = get_clock_hands(plt.imread('clock_images/batch_2/clock_19.png'))[1]
# # print(task_hr)
# # print(task_min)
...
#print(get_angle(task_hr))  
#print(get_angle(task_min)) 
# print(get_angle(task2_min))  
# print(get_angle(task2_hr))
# print(get_angle(task3_hr))
...
print(draw_clock(get_angle(task2_hr),get_angle(task2_min)))
print(draw_clock(get_angle(task_hr),get_angle(task_min)))
print(draw_clock(get_angle(task3_hr),get_angle(task3_min)))
...
# print(analog_to_digital(get_angle(task2_hr),get_angle(task2_min)))
# for i in range (30):
#      print('clock'+ str(i))
#      print(get_angle(get_clock_hands(plt.imread('clock_images/batch_4/clock_'+str(i)+'.png'))[0]))
#      print(get_angle(get_clock_hands(plt.imread('clock_images/batch_4/clock_'+str(i)+'.png'))[1]))
#      print(analog_to_digital(get_angle(get_clock_hands(plt.imread('clock_images/batch_4/clock_'+str(i)+'.png'))[0]),get_angle(get_clock_hands(plt.imread('clock_images/batch_4/clock_'+str(i)+'.png'))[1])))
#      print('_________')

#print(analog_to_digital(plt.imread('clock_images/batch_1/clock_0.png'))[0]),get_angle(get_clock_hands(plt.imread('clock_images/batch_1/clock_0.png'))[1])
...
# print(check_alignment(get_angle(task2_hr),get_angle(task2_min)))
...
def validate_batch(path, tolerance):
    ...
    for clock in sorted_readjusted_list:
        f.write(clock[0] + '=' + str(clock[1]) +'min\n')
